...
object Publish extends App {
  ...
  implicit val spark: SparkSession = SparkSession.builder
    ...
    .enableHiveSupport()
    .appName(s"Publishing for $studyIds - $releaseId").getOrCreate()
  ...
  private def publishTable(releaseId: String, tableName: String)(implicit spark: SparkSession): Unit = {
  ...
  private def publishOccurrences(studyIds: String, releaseId: String)(implicit spark: SparkSession): Unit = {
