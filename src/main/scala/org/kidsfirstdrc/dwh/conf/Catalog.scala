...
object Catalog {
  ...
  object Raw extends StoreFolder {
    ...
    val gnomad_genomes_3_1_1      = DatasetConf("gnomad_genomes_3_1_1"     , alias, "/raw/gnomad/r3.1.1/gnomad.genomes.v3.1.1.sites.*.vcf.gz" ,    VCF , OverWrite)
  ...
  object Public extends StoreFolder {
    ...
    val gnomad_genomes_3_1_1 = DatasetConf("gnomad_genomes_3_1_1"  ,alias, "/public/gnomad_genomes_3_1_1", PARQUET, OverWrite, TableConf("variant", "gnomad_genomes_3_1_1"))
