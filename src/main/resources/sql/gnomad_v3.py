...
df.repartition("chromosome").sortWithinPartitions("start").write.mode('overwrite').format("parquet").option("path", "s3a://kf-strides-variant-parquet-prd/public/gnomad/gnomad_genomes_3.0").saveAsTable("variant.gnomad_genomes_3_0")