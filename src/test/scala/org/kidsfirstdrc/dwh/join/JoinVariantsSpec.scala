  ...
  "build" should "return a dataframe with all expected columns" in {
    withOutputFolder("output") { outputDir =>
      ...
      val expectedOutput = Seq(
        JoinVariantOutput(
          frequencies = VariantFrequency(Freq(11,6,0.5454545454545454,7,1),Freq(11,6,0.5454545454545454,7,1)),
          ...
          upper_bound_kf_af_by_study = Map(studyId3 -> 0.2857142857142857, studyId1 -> 1, studyId2 -> 1),
          ...
          lower_bound_kf_af_by_study = Map(studyId3 -> 0.2857142857142857, studyId1 -> 1, studyId2 -> 1),
