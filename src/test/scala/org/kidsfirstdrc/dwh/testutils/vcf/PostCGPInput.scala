...
case class AMINO_ACIDS(`reference`: Option[String] = None, `variant`: Option[String] = None)

case class Exon(`rank`: Option[Int] = None, `total`: Option[Int] = None)

case class Intron(`rank`: Int = 2, `total`: Int = 10)

case class CODONS(`reference`: Option[String] = None, `variant`: Option[String] = None)
