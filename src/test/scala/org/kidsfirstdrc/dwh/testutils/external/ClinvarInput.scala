...
case class ClinvarInput(
    ...
    INFO_CLNDISDB: List[String] =
      List("MONDO:MONDO:0012518", "MedGen:C3552335", "OMIM:610542|MedGen:CN169374|MedGen:CN517202"),
    INFO_CLNREVSTAT: List[String] =
      List("criteria_provided", "_multiple_submitters", "_no_conflicts"),
