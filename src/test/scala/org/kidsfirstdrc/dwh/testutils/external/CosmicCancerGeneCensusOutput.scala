...
case class CosmicCancerGeneCensusOutput(
    `symbol`: String = "BRAF",
    ...
    `tumour_types_somatic`: List[String] = List(
      "melanoma",
      "colorectal",
      "papillary thyroid",
      "borderline ovarian",
    ...
    `tumour_types_germline`: Option[List[String]] = Some(
    ...
    `translocation_partner`: List[String] = List(
      "AKAP9",
      "KIAA1549",
      "CEP88",
      "LSM14A",
