...
case class GenomicFileOutput(
    `acl`: List[String] = List("phs001168.c1", "SD_9PYZAHHE"),
    `access_urls`: List[String] = List(
      "https://data.kidsfirstdrc.org/data/a6bccb21-5b16-4ceb-bb61-6416212eed56"
    ),
    ...
    `external_id`: String =
      "kf-study-us-east-1-prd-sd-9pyzahhe/harmonized/cram/15432d95-83da-4c55-be58-55e9e4ec587b.cram",
    ...
    `urls`: List[String] = List(
      "s3://kf-study-us-east-1-prd-sd-9pyzahhe/harmonized/cram/15432d95-83da-4c55-be58-55e9e4ec587b.cram"
    ),
