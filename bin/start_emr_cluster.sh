...
aws emr create-cluster --applications Name=Hadoop Name=Spark Name=Zeppelin Name=JupyterHub --ebs-root-volume-size 50 --ec2-attributes '{"KeyName":"flintrock","InstanceProfile":"kf-variant-emr-ec2-prd-profile","SubnetId":"subnet-00aab84919d5a44e2","ServiceAccessSecurityGroup":"sg-0587a1d20e24f4104","EmrManagedSlaveSecurityGroup":"sg-0dc6b48e674070821","EmrManagedMasterSecurityGroup":"sg-0a31895d33d1643da"}' \
