...
input=${2:-"s3a://kf-strides-variant-parquet-prd/portal/es_index/variants_suggestions_re_000012/"}
...
es_index_name=${4:-"variants_suggestions"}
es_index_template=${5:-"variants_suggestions_template.json"}
