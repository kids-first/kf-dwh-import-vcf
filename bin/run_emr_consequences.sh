...
--steps '[{"Args":["spark-submit","--packages","io.projectglow:glow_2.11:0.2.0","--deploy-mode","client","--class","org.kidsfirstdrc.dwh.vcf.ImportVcf","s3a://kf-variant-parquet-prd/jobs/kf-dwh-import-vcf.jar","SD_9PYZAHHE","RE_123456","s3a://kf-study-us-east-1-prd-sd-9pyzahhe/harmonized/family-variants/*.vcf.gz","s3a://kf-variant-parquet-prd", "consequences"],"Type":"CUSTOM_JAR","ActionOnFailure":"TERMINATE_CLUSTER","Jar":"command-runner.jar","Properties":"","Name":"Spark application"}]' \
--name 'Variant Import to DWH - Consequences' \
--instance-groups '[{"InstanceCount":20,"InstanceGroupType":"CORE","InstanceType":"m5d.4xlarge","Name":"Core - 2"},{"InstanceCount":1,"EbsConfiguration":{"EbsBlockDeviceConfigs":[{"VolumeSpecification":{"SizeInGB":32,"VolumeType":"gp2"},"VolumesPerInstance":2}]},"InstanceGroupType":"MASTER","InstanceType":"m5.xlarge","Name":"Master - 1"}]' \
